...
**The one live thread is the inversion, and it points the other way.** Every surviving signal in this population says *back the elite LEADER, or at minimum stop treating elite trailers as buys*: earned leads hold, hot leads hold, the trailer is systematically overpriced. That is a **mirror observation and explicitly POST-HOC** — the compression study's leader-spread mirror is the precedent, and it earned a forward-tape prereg, not a promotion. It is named here and deferred; it does **not** get retro-fitted onto this prereg's bars.
