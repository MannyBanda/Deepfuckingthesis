...
+ '  QUARTER-AWARE TRUST HIERARCHY (14,440 checkpoint backtest, 1,233 games):\n'
+ '  All four are most reliable when they AGREE. When ALL 3 (MC+XGB+Floor) agree high in Q4: 95.9% accuracy.\n'
+ '  When they DISAGREE, which to trust depends on quarter:\n\n'
+ '  Q2: Floor ~ XGB > MC\n'
+ '    MC is overconfident by 10-22pp in Q2. MC reading of 90% converts at only 75%. Floor and XGB have fuller sample.\n'
+ '    MC useful as early warning, not a prediction. Frame MC divergence as "worth watching" not "confirmed."\n\n'
+ '  Q3: MC Cum ~ XGB > Floor\n'
+ '    MC calibration tightens (Brier 0.22 vs Q2 0.28). MC 70-80% converts at 77.5%. Floor starts anchoring from Q1 data.\n'
+ '    When MC and floor disagree in Q3, MC is right 64%. Weight MC Cum and XGB roughly equally. Flag floor-MC divergence as risk.\n\n'
+ '  Q4: MC Cum > XGB > Floor\n'
+ '    MC 70-80% converts at 75.3% (0.1pp calibration error). MC>70% accuracy: 91.9%. Remaining possessions < sample window.\n'
+ '    Floor is least reliable — cumulative anchoring at maximum. When MC>=0.65 and floor<0.55, MC is right 82.1%.\n'
+ '    XGB 2Q window strips stale early-game data — more reliable than cumulative XGB. Biglead anchoring still present.\n'
+ '    Trust MC Cum over floor for FWP in Q4. When floor says 0.90 and MC says 0.30, MC is right.\n\n'
