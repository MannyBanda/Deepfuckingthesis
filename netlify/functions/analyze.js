...
+ 'I1 Disruption & Conversion (10%): Steals+blocks differential (±1) + points off turnovers differential (±4). Chaos layer: forced vs unforced TO gap (±4, ±0.5 weight)\n'
+ 'I2 Interior Control (15%): Paint points differential (±6) + rim FG% differential (±10%, min 6 attempts)\n'
+ 'I3 Shot Quality & Creation (20%): eFG% differential (±2%), assist ratio differential (±5%), shot diet sustainability\n'
+ 'I4 Game Control (30%): Biggest lead differential (±4) + last quarter scoring differential (±2, Q4+ only). Most predictive indicator — 98.7% accurate.\n'
+ 'I5 Sustained Execution (25%): Run share from play-by-play (55/45 threshold, min 4 runs of 6+ pts). Measures sequential scoring dominance.\n\n'
...
+ '     I1: Steals, Blocks | I2: Paint pts, Rim FG% | I3: eFG%, Assist ratio | I4: Biggest lead | I5: Run share\n'
