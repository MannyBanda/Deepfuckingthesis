...
+ 'MONTE CARLO TRAJECTORY & SIGNAL TRUST HIERARCHY:\n'
+ '  MC PBP computes win probability from RECENT possession-level rates (last 20 possessions). Immune to cumulative anchoring.\n'
+ '  MC Cum computes win probability from FULL GAME cumulative rates. Best single probability signal (AUC 0.79).\n'
+ '  Always-on MC trajectory (mc_win_prob): PBP available every poll Q2+. MC Cum (mc_cum_win_prob) also available Q2+.\n\n'
+ '  WHAT EACH SIGNAL MEASURES:\n'
+ '  - Floor: cumulative game box score -> I1-I5 weighted composite. Full-game view. Stable but anchors stale early-game data.\n'
+ '  - XGB: 2Q cross-fade windowed stats -> 13-feature structural model. Uses recent ~2 quarters. Biglead stays cumulative.\n'
+ '  - MC PBP: last 20 possessions only -> simulated forward. Real-time canary for structural shifts.\n'
+ '  - MC Cum: full game cumulative rates -> simulated forward. Best probability anchor. Dominates disagreements 70-87%.\n\n'
+ '  QUARTER-AWARE TRUST HIERARCHY [PRIOR — 14,440 checkpoint backtest, 1,233 games; backtest/checkpoint-granularity, production runs differently (XGB ~0.81 backtest vs ~0.67 prod). Reason from these, do NOT quote as the subscriber\'s win prob]:\n'
+ '  All four are most reliable when they AGREE. All 3 high in Q4 ~96% (backtest).\n'
+ '  When they DISAGREE, which to trust depends on quarter [STRUCT — direction]:\n\n'
+ '  Q2: Floor ~ XGB > MC\n'
+ '    MC is overconfident early; treat as early warning, not a prediction. Frame MC divergence as "worth watching" not "confirmed."\n\n'
+ '  Q3: MC Cum ~ XGB > Floor\n'
+ '    MC calibration tightens. Weight MC Cum and XGB roughly equally. Flag floor-MC divergence as risk.\n\n'
+ '  Q4: MC Cum > XGB > Floor\n'
+ '    [PRIOR] MC 70-80% ~75% actual, MC>70% ~92% (backtest). Floor least reliable (cumulative anchoring at max).\n'
+ '    XGB 2Q window strips stale early-game data — more reliable than cumulative XGB.\n'
+ '    Trust MC Cum over floor for FWP in Q4. When floor says 0.90 and MC says 0.30, MC is right. [STRUCT]\n\n'
+ '  MC INVESTIGATION (when active — any quarter):\n'
+ '    When MC investigation is active: MC PBP > XGB > Floor > Graduation badge, REGARDLESS of quarter.\n'
+ '    CLEAN = sustained collapse (72.6% precision Q3+). Post-trigger rates never recovered. Strongest MC signal.\n'
...
+ 'SIGNAL TRUST HIERARCHY [tags: [PRIOR]=well-powered backtest, reason from it not a quote; [STRUCT]=direction only; [OP]=mechanical gate]:\n'
+ '  Q2: Floor ≈ XGB > MC. [STRUCT]\n'
+ '  Q3: MC ≈ XGB > Floor. [STRUCT]\n'
+ '  Q4: MC >= XGB > Floor. MC wins late disagreements with floor. [STRUCT]\n'
+ '  Floor is NEVER a gate for WNBA decisions — narrative context only. [STRUCT]\n'
+ '  [PRIOR] MC underestimates WNBA Q4: MC ~0.75 runs ~89% actual (backtest) — reason from it, do not quote.\n\n'
+ 'BUY (control team trailing) — value is in the PRICE, not the binary outcome. A structurally dominant team trailing is MISPRICED; a low win rate at plus money is profitable. Do NOT suppress just because the win rate looks like a coin flip.\n'
+ '  [OP] Mechanical BUY gate (system auto-suppresses): Q4 XGB < 0.55, Q1-Q3 XGB < 0.45.\n'
+ '  [STRUCT] Deficit: 1-9 max (not 1-15 like NBA); 1-4 is the sweet spot. Losing I3 is structural death in WNBA (the 30% anchor), not recoverable cold shooting.\n'
+ '  [OP] Compound establishment: MC Cum >= 0.80 + XGB >= 0.60 (floor demoted, not a gate).\n';
