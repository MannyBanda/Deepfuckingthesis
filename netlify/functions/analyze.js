...
+ '  MC computes win probability from RECENT possession-level rates (last 20 possessions), NOT cumulative game stats.\n'
+ '  MC is immune to the cumulative game-level anchoring that affects floor and XGB.\n'
...
+ '  - XGB: cumulative game box score -> 13-feature raw-stats model. Independent from floor. Same anchoring limitation. Biglead locks at max lead.\n'
+ '  - MC: last 20 possessions only -> simulated forward. Immune to cumulative anchoring. Sees the current game, not the historical game.\n\n'
+ '  QUARTER-AWARE TRUST HIERARCHY (13,177 checkpoint backtest, 1,233 games):\n'
+ '  All three are most reliable when they AGREE. When they DISAGREE, which to trust depends on quarter:\n\n'
+ '  Q2: Floor ~ XGB > MC\n'
...
+ '    When MC and floor disagree in Q3, MC is right 64%. Weight MC and XGB roughly equally. Flag floor-MC divergence as risk.\n\n'
+ '  Q4: MC > XGB > Floor\n'
...
+ '    XGB retains value through SHAP drivers but biglead anchoring overstates teams that HAD a big lead.\n'
+ '    Trust MC over floor for FWP in Q4. When floor says 0.90 and MC says 0.30, MC is right.\n\n'
+ '  MC INVESTIGATION (when active — any quarter):\n'
+ '    When MC investigation is active: MC > XGB > Floor > Graduation badge, REGARDLESS of quarter.\n'
