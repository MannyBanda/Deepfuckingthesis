...
function buildSystemPrompt() {
  return [
    ...
    '',
    'OUTPUT: Compact thesis format with AVAILABILITY (showing SIA), CONTROL SCORE, I1-I5, SHOT DIET, 3PT HEATER WATCHLIST, KEY FLAGS, MARKET, ML THRESHOLD, ENTRY, PASS, CLUTCH GATE, WATCH.'
  ].join('\n');
}
