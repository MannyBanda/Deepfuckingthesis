...
function buildSystemPrompt() {
  return [
    ...
    '',
    '3PT VULNERABILITY PROFILE (both teams): ELITE (38%+ on 4+ 3PA/gm — sustainable, identity shooter), VOLATILE (33-38% on 3+ att/gm — streaky, could go hot or cold), NON-SHOOTER (<33% or <1.5 3PA/gm — if hitting, regression is coming). Name 2-3 per team.',
    '',
    ...
    '[TEAM]: [Player] ([szn 3PT%] on [vol]/gm) [ELITE|VOLATILE|NON-SHOOTER], ...',
    '',
    'KEY FLAGS',
    '\u26A0 [Flag]',
    '\u2713 [Clean note]',
